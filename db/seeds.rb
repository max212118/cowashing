...
user2 = User.create!(nickname: 'Le Pauvre', first_name: 'Mike', last_name: 'Jonas', age: 23, password: "123456", email: "Mike@gmail.com", profile_picture: "https://avatars.githubusercontent.com/u/94915071?v=4")
